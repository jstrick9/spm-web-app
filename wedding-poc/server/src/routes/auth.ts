 ...
 *
 * Registration auto-creates a personal organization for the new user, so
 * they can immediately create events. (Multi-tenant org joining is a later
 * feature; the data model supports it from day one.)
 */
