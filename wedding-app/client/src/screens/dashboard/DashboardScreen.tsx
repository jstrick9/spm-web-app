...
export function DashboardScreen({
  ...
  const updateCommunicationTemplateMutation = useMutation({ mutationFn: ({ id, body }: { id: string; body: string }) => sdk.events.updateCommunicationTemplate(id, { body }), onSuccess: () => { qc.invalidateQueries({ queryKey: ['communication-templates', orgId] }); } });
