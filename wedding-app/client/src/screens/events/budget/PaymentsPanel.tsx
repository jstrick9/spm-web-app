...
import { CreditCard, Plus, ExternalLink, RefreshCw, Printer } from 'lucide-react';
import { sdk } from '../../../sdk';
...
export function PaymentsPanel({ eventId }: Props) {
  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setAddOpen(false); setAmount(''); setDueDate('');
      ...
      const html = `
        ...
        <body>
          <div class="receipt-box">
             <div class="header">
                <div class="venue-name">Seven Paths Manor</div>
             ...
             <div class="footer-note">
                Thank you for your business. For billing inquiries, contact coordinator@sevenpathsmanor.com.
             </div>
          </div>
          <script>
