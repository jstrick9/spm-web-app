...
import { orgsRepo, usersRepo, staffTasksRepo } from '../db/repos/index.js';
...
describe('Staff RBAC Integration', () => {
    ...
    beforeEach(async () => {
        applyAllMigrations();
        const { rolesRepo } = await import('../db/repos/index.js');
        ...
        staffId = staff.id;
        // Create roles
        const staffRole = rolesRepo.createCustom({ organizationId: orgId, key: 'test_staff', name: 'Staff', createdBy: owner.id, hierarchy: 10, permissions: ['staff.view'] });
...
//# sourceMappingURL=staff.integration.test.js.map