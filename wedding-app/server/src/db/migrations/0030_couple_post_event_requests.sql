-- ============================================================
-- Migration 0030: Couple post-event closeout request types
-- ============================================================

CREATE TABLE IF NOT EXISTS couple_portal_requests_next (
  id              TEXT PRIMARY KEY,
...
INSERT OR IGNORE INTO couple_portal_requests_next
  (id, organization_id, event_id, requester_user_id, request_type, status, target_email, target_name, note, metadata, reviewed_by, reviewed_at, created_at, updated_at)
SELECT id, organization_id, event_id, requester_user_id, request_type, status, target_email, target_name, note, metadata, reviewed_by, reviewed_at, created_at, updated_at
FROM couple_portal_requests;

DROP TABLE couple_portal_requests;
ALTER TABLE couple_portal_requests_next RENAME TO couple_portal_requests;
